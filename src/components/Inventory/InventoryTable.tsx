...
import { getPlants } from "@/Actions/plant.action"; // ✅ FIXED casing
...
type Plants = Awaited<ReturnType<typeof getPlants>> | undefined; // ✅ FIXED
type Plant = NonNullable<Plants>["userPlants"][number]; // ✅ FIXED (safe access)
